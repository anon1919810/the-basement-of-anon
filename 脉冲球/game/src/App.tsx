...
export default function App() {
  ...
  return (
    <div className="app">
      <header>
        <h1>脉冲球 <span>PULSE BALL · v0.0.0</span></h1>
        <p className="tagline">确定性比赛引擎 · Canvas 可视化回放 · 9v9 · 三节净时 + 金球加时 + 点球大战</p>
      </header>
      ...
      <footer>脉冲球 · 原型 v0.0.0 · 端明ちゃん 定方向 · 引擎确定性由 mulberry32 保证</footer>
    </div>
  );
}
